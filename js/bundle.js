...
function initLocaleSettings (selector, activeClass) {
...
initLocaleSettings('#gender div', 'calculating__choose-item_active');
initLocaleSettings('.calculating__choose_big div', 'calculating__choose-item_active');
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-08-25');
